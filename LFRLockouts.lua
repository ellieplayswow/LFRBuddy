...
-- [expansion_id] = { [instance_id] = { [gossip_id] = <boss_index> } }
local lockoutData = {
    [4] = {
        [967] = { -- dragon soul
        ...
        for i = 1, #f.gossipOptions do
            ...
            if gossipData[id] ~= nil then
                ...
                if gossipData[id] == true then
                    f.gossipOptions[i].icon = "Interface\\AddOns\\LFRBuddy\\Art\\Lockout_Green"
				else
					f.gossipOptions[i].icon = "Interface\\AddOns\\LFRBuddy\\Art\\Lockout_Red"
                end
			else
				f.gossipOptions[i].icon = "Interface\\AddOns\\LFRBuddy\\Art\\Lockout_Red"
            end
